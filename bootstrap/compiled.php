...
class Application extends Container implements HttpKernelInterface, TerminableInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Applications/XAMPP/xamppfiles/htdocs/skeleton-key/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function __construct()
    {
        ...
        $this->searchPaths[] = '/Applications/XAMPP/xamppfiles/htdocs/skeleton-key/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
    }
    public function handle()
    {
